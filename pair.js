...
const config = {
    ...
    PREFIX: '.',
    MAX_RETRIES: 3,
    IMAGE_PATH: 'https://files.catbox.moe/84288h.jpg',
    GROUP_INVITE_LINK: 'https://chat.whatsapp.com/CDPTTUY9PahGCIAkmmPXc2',
...
User Message: ${q}
    ...
    const apis = [
        ...
        `https://real.api.id.dexter.it.com/ai/gptturbo?apikey=gifted&q=${encodeURIComponent(prompt)}`,
        `https://jani-v6ox.onrender.com/api/gpt?q=${encodeURIComponent(prompt)}`
    ];
